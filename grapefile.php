...
function grapefile_notice() {
	$info = __( '<br /><div class="update-message" style="background:#000;color:#fff;">&nbsp;- HEY YOU...Ya You With The Eyeballs. A New Version is Available, <a href="http://grapefile.info/upgrading.php" target="_blank" style="color:#168e8f;">Click Here</a> For Upgrade Instructions...I Recommend It!!</div>' );
	echo '<span class="spam">' . $info . '</span>';
}
add_action( 'in_plugin_update_message-' . plugin_basename(__FILE__), 'grapefile_notice' );
function krs_one() { ?>
<div class="wrap">
